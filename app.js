...
const initialStaff = [
  ...
  { id: 5, name: "中西崇之", company: "ソフトバンク", role: "アシスタント", email: "nakanishi@design.co.jp", hoursPerDay: 8, manualLoadHours: 9, skills: ["進行補助","入稿"], avatar: "西" },
];
...
function renderCalendarDetailModal(){
  ...
  <div class="top-actions" style="justify-content:flex-end;margin-top:16px"><button class="btn" onclick="closeCalendarDetail()">閉じる</button><button class="btn primary" onclick="closeCalendarDetail(); openCalendarQuickEdit(${order.id})">この案件を編集</button></div></div></div>`;
}
